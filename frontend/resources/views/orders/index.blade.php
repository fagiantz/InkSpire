    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <h2 class="fw-bold mb-2">PESANAN</h2>
                <h5 class="fw-bold mb-3">Riwayat Pesanan</h5>

                <!-- Kartu Riwayat Pesanan Dummy -->
                <div class="order-card d-flex flex-column flex-md-row align-items-md-center gap-3">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="mb-0 text-muted">Status Pesanan: Selesai</p>
                    </div>
                    <!-- Total & Waktu Transaksi -->
                    <div class="text-md-end">
                        <p class="fw-bold fs-5">Rp. 20.000</p>
                        <p class="mb-0 text-muted small">12 Maret 2025 — 12:00 WIB</p>
                    </div>
                </div>
            </div>
        </div>
